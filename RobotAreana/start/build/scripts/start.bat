...
set CLASSPATH=%APP_HOME%\lib\start.jar;%APP_HOME%\lib\AIBasic.jar;%APP_HOME%\lib\robot.jar;%APP_HOME%\lib\main.jar

@rem Execute start
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %START_OPTS%  -classpath "%CLASSPATH%" ExampleSwingApp %CMD_LINE_ARGS%
